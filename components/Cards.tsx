  ...
  return (
    <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
        ...
        <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
            <Text className='text-xl font-rubik-extrabold text-white' numberOfLines={1}>Mordern Aparment</Text>
    ...
    <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
      <View className='flex flex-row items-center absolute px-2 top-5 right-5 bg-white/90 p-1 rounded-full z-50'>
        ...
        <View className='flex flex-col mt-2'>
            <Text className='text-base font-rubik-bold text-black-300' numberOfLines={1}>Mordern Aparment</Text>
            <Text className='text-xs font-rubik-bold text-black-200'>New York test 2</Text>
